...
export const metadata: Metadata = {
  ...
  description:
    "Five committees, one society: Asset Management, Private Equity, Venture Capital, Events, and Marketing.",
};
    ...
    <main>
      ...
      <div className="mt-16 max-w-column space-y-6 font-serif text-[17px] leading-relaxed text-am-text/86">
        ...
        <p>
          ...
          Capital, Events, or Marketing — and take on real responsibility
          throughout the year.
        </p>
        <p>
