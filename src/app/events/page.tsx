  ...
  return (
    <main>
      ...
      <div className="mx-edge pb-24 md:pb-28">
        ...
        <section className="mt-8 border border-am-text/15 p-8 sm:p-10 md:mt-0">
          <Tagline className="text-am-gold">Pareto Cup</Tagline>
          <div className="mt-6 flex flex-col items-start gap-6 sm:flex-row sm:items-center">
            <div
              className="flex h-24 w-24 shrink-0 items-center justify-center rounded-full border border-am-text/20 font-sans text-[11px] tracking-label text-am-text/60"
              aria-hidden="true"
            >
              TBD
            </div>
            <p className="max-w-column font-serif text-[16px] leading-relaxed text-am-text/75">
